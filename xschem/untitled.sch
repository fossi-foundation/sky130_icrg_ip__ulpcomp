...
N 510 -640 510 -610 {
lab=dvdd}
C {devices/lab_pin.sym} 220 -460 0 0 {name=p15 sig_type=std_logic lab=clkb
}
...
C {devices/lab_pin.sym} 250 -310 0 0 {name=p25 sig_type=std_logic lab=opos}
C {devices/lab_pin.sym} 790 -310 2 0 {name=p26 sig_type=std_logic lab=oneg}
...
C {devices/lab_pin.sym} 410 -610 0 0 {name=p35 sig_type=std_logic lab=enab}
C {devices/lab_pin.sym} 510 -560 2 0 {name=p36 sig_type=std_logic lab=dvddb}
C {sky130_fd_pr/nfet_03v3_nvt.sym} 330 -310 0 0 {name=M13
L=0.5
W=2
nf=1
mult=1
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 570 -250 0 0 {name=M14
L=0.5
W=2
nf=1
mult=1
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 460 -250 0 1 {name=M16
L=0.5
W=2
nf=1
mult=1
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 710 -310 0 1 {name=M17
L=0.5
W=2
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_hvt.sym} 490 -610 0 0 {name=M23
L=0.15
W=1
nf=1
mult=1
