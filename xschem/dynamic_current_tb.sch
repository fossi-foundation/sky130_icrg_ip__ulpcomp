...
C {devices/vsource.sym} 270 -700 0 0 {name=V6 value="DC 1.8" savecurrent=false}
C {devices/gnd.sym} 270 -670 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 270 -780 0 0 {name=p15 sig_type=std_logic lab=ena}
C {devices/vsource.sym} 90 -810 0 0 {name=V7 value="DC 0 sin(0 3.3 2MEG 0 0)" savecurrent=false}
C {devices/vsource.sym} 180 -750 0 0 {name=V8 value="DC 0 sin(0 3.3 9MEG 0 0)" savecurrent=false}
C {devices/gnd.sym} 90 -780 0 0 {name=l7 lab=GND}
C {devices/gnd.sym} 180 -720 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} 90 -900 0 0 {name=p16 sig_type=std_logic lab=vinp}
