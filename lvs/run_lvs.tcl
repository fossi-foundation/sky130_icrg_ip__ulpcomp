...
set circuit1 [readnet spice ../netlist/layout/sky130_icrg_ip__ulpcomp2.spice]
set circuit2 [readnet spice $hvlib]
readnet spice ../netlist/schematic/sky130_icrg_ip__ulpcomp2.spice $circuit2

lvs "$circuit1 sky130_icrg_ip__ulpcomp2" "$circuit2 sky130_icrg_ip__ulpcomp2" \
	$setupfile sky130_icrg_ip__ulpcomp2_comp.out
