...
set circuit1 [readnet spice $CACE_ROOT/netlist/layout/${ipname}2.spice]
set circuit2 [readnet spice $hvlib]

#readnet spice $hdlib $circuit2
readnet spice $CACE_ROOT/netlist/schematic/${ipname}2.spice $circuit2

#debug on

lvs "$circuit1 ${ipname}2" "$circuit2 ${ipname}2" $setupfile ${ipname}2_comp.out -json
