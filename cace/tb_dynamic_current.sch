...
S {}
E {}
T {Power Consumption (Enable/Dynamic)} 90 -650 0 0 0.4 0.4 {}
N 870 -355 930 -355 {
lab=vout}
N 100 -555 100 -495 {
lab=vinp}
...
C {devices/vsource.sym} 400 -465 0 0 {name=V3 value="Pulse(0 \{ena\}*1.8 0 0.1n 0.1n 0.5n 1n)" savecurrent=false}
...
quit
.endc"}
C {devices/vsource_arith.sym} 250 -465 0 0 {name=E1 VOL="DC 0 sin(0 \{Vdiff\} \{frequency2\} 0 0)"}
C {devices/vsource_arith.sym} 100 -465 0 0 {name=E2 VOL="DC 0 sin(0 \{Vdiff\} \{frequency1\} 0 0)"}
